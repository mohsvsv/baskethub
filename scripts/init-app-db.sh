...
-------- create users --------
CREATE USER $APP_DB_STREAMLIT_USER WITH PASSWORD '$APP_DB_STREAMLIT_PASSWORD';
CREATE USER $APP_DB_AIRFLOW_USER WITH PASSWORD '$APP_DB_AIRFLOW_PASSWORD';

-- add privileges to streamlit user
GRANT CONNECT ON DATABASE $APP_DB_NAME TO $APP_DB_STREAMLIT_USER;
GRANT USAGE ON SCHEMA public TO $APP_DB_STREAMLIT_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO $APP_DB_STREAMLIT_USER;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO $APP_DB_STREAMLIT_USER;

-- add privileges to airflow user
GRANT CONNECT ON DATABASE $APP_DB_NAME TO $APP_DB_AIRFLOW_USER;
GRANT USAGE ON SCHEMA public TO $APP_DB_AIRFLOW_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO $APP_DB_AIRFLOW_USER;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO $APP_DB_AIRFLOW_USER;
EOSQL